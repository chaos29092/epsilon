...
@section('content')
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                ...
                <div class="store-slider-item-description content">
                    ...
                    <div class="demo-socials">
                        <a href="{{setting('slide.a_1')}}" class="button button-icon  sms-bg"><i class="ion-ios-star"></i>{{title_case(__('main.click_to_see_the_details'))}}</a>
                        <div class="clear"></div>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                ...
                <div class="store-slider-item-description content">
                    ...
                    <div class="demo-socials">
                        <a href="{{setting('slide.a_2')}}" class="button button-icon  sms-bg"><i class="ion-ios-star"></i>{{title_case(__('main.click_to_see_the_details'))}}</a>
                        <div class="clear"></div>
                    </div>
                </div>
            </div>
    ...
    <div class="content">
        <div class="container heading-style">
            <h4 class="heading-title">{{title_case(__('main.products_categories'))}}</h4>
        ...
        <div class="one-half-responsive">
            <div class="content">
                <h1 class="thin center-text">{{title_case(__('main.about_us'))}}</h1>
